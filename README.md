...
<img src="https://github.com/user-attachments/assets/e93774b8-e69b-41a5-8bb7-4ae82031ca98" alt="Amanda standing in front of a textured wall, smiling" width="420" />
...
I genuinely enjoy cleaning up **technical debt** 🧹 — it’s one of the fastest ways to improve the health of a system. I also use **AI-powered codemods** 🤖 to run audits, identify **drift**, and keep systems **aligned** with their original intent.

## 🎯 Current areas of focus

### 🎨 Design systems

- **Atomic Design** and **component-driven architecture**
- **Design tokens** as a **single source of truth**
- Bridging **design intent** and **production code**
- Tooling and documentation that support **adoption at scale**

### 🧩 Legacy code

- Removing **deprecated** and **dead code**
